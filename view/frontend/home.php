...
?>
  ...
  <div class="container" id="bigContainer">
    ...
    <div class='container' id="conteneur_portfolio">

    <div class="row mb-2"> <!--ajout d'un bloc pour mettre en avant le projet hucLink!-->
        <div class="col-12 col-md-6 element d-flex justify-content-center" id="elementhuclink">
        ...
        <div class="col-12 col-md-6 element d-flex justify-content-center" id="elementajjardin">
          <div id="containerajHome" class="allContainerHome">
      ...
      <div class="d-flex justify-content-center"> <!--pour centrer l'image dans la div!-->
        <div class="col-12 col-md-6 element d-flex justify-content-center" id="elementp5">
      ...
      <div class="row mb-2">
        <div class='col-12 col-md-6 element' id="elementp4">
        ...
        <div class='col-12 col-md-6 element' id="elementp3">
      ...
      <div class="row">
        <div class=' col-12 col-md-6 element' id="elementp2">
        ...
        <div class='col-12 col-md-6 element' id="elementp1">
